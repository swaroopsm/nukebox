...
},{"./components/app":158,"react":156}],158:[function(require,module,exports){
var React = require('react');
      ...
      React.createElement("div", {className: "row"}, 
        React.createElement("div", {className: "col-md-12"}, 
          React.createElement("div", {className: "col-md-4"}, 
            React.createElement(List, {messages:  this.state.messages, activateMessage:  this.activateMessage})
          ), 
          React.createElement("div", {className: "col-md-8"}, 
            React.createElement(MessageArea, {message:  this.state.activeMessage})
          )
        )
      )
    );
...
},{"./list":160,"./messagearea":161,"react":156}],159:[function(require,module,exports){
var React = require('react');
...
var Item = React.createClass({displayName: "Item",
  ...
  render: function() {
    ...
    return (
      React.createElement("li", {className:  className, onClick:  this.activateMessage}, 
        React.createElement("img", {src:  this.props.user.avatar_url, className: "img-circle pull-left"}), 
        React.createElement("h5", null,  this.props.subject), 
        React.createElement("p", null, 
          React.createElement("small", null,  this.props.user.name)
        )
      )
    );
  }
...
var List = React.createClass({displayName: "List",
  ...
  render: function() {
    ...
    var messages = this.props.messages.map(function(message) {
      ...
      return (
        React.createElement(Item, {key:  message.id, isActive:  isActive, onClick:  this.activateMessage, id:  message.id, subject:  message.subject, user:  message.user})
      );
    }.bind(this));
...
},{"./item":159,"react":156}],161:[function(require,module,exports){
var React = require('react');
    ...
    if(this.props.message === null) {
      ...
      return (
        React.createElement("div", {className: ""}, 
          React.createElement("div", {className: ""}, 
            React.createElement("h3", null,  this.props.message.subject), 
            React.createElement("hr", null), 
            "From: ", React.createElement("strong", null,  this.props.message.user.name), 
            React.createElement("p", null,  this.props.message.body)
          )
        )
      )
    }
